export default function Pricing() {
  return (
    <div className='container py-12'>
      <h1 className="mt-4 mb-16 text-center text-4xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-gray-950 via-sky-700 via-30% to-sky-400">
      ...
      <div className="flex flex-col gap-8">
        <section className="flex flex-col gap-4 p-6 bg-white rounded-xl drop-shadow-sm">
          ...
          <div>
            ...
            <ul className='text-muted-foreground list-inside list-disc'>
              <li>College: NT$12,000 / essay</li>
              <li>Graduate School: NT$14,000 / essay</li>
            </ul>
          </div>
        </section>
        ...
        <section className="flex flex-col gap-4 items-start p-6 bg-white rounded-xl leading-loose drop-shadow-sm">
          <h3 className="text-3xl font-semibold">Package work</h3>
          <h4 className="font-semibold">Basic package: $85,000NTD</h4>
          <div className="text-muted-foreground">
            ...
            <br />
            <p>
              The definition of an essay: 500-1,000 words (Both Common and Coalition Apps advise an applicant to submit an essay of between 550-650 words)<br /><br />
              Many colleges and universities that accept the Common and or Coalition application require you to submit at least one essay as part of your application. In cases like Stanford, Yale, and MIT where short response essays are preferred, i.e. 250 words maximum per essay, we will consider three separate essays as ONE.<br /><br />
              When applying to universities like the University of Chicago or Yale where each university requires two essays–both require about 500 words or more–you will use up the 2 essays quota in this basic package.<br /><br />
          ...
          <p className="text-muted-foreground">The student must complete all three essays included in this basic package within 10 weeks, commencing from the date of the first conference</p>
