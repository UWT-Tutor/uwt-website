  ...
  return (
    <div>
      ...
      <p className="mt-8 leading-relaxed text-muted-foreground">
        ...
        tutors who have years of experience in crafting high-quality essays and
        ...
        students with the necessary tools to succeed in their academic writing while
        also fostering a love for writing and creativity.
        <br />
        <br />
        &emsp;Our approach is centered on personalized instruction, as we believe that every
        student is unique and requires a tailored approach. We work closely with our students
        ...
        goals while also nurturing their creativity and passion for writing. Join us
